...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // Predix
        hashUTXORoot.SetNull(); // Predix
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //Predix
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //Predix
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //Predix
    {
