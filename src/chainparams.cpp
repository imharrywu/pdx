...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    genesis.hashStateRoot = uint256(h256Touint(dev::h256("e965ffd002cd6ad0e2dc402b8044de833e06b23127ea8c3d80aec91410771495"))); // Predix
    genesis.hashUTXORoot = uint256(h256Touint(dev::sha3(dev::rlp("")))); // Predix
    return genesis;
}
...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000036a70ae675b98824c5"); // Predix
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("Predix4.dynu.net", "Predix4.dynu.net", false)); // Predix testnet
